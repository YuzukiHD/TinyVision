...
GLOBAL int nand_physic_write_page(unsigned int chip, unsigned int block, unsigned int page, unsigned int bitmap, unsigned char *mbuf, unsigned char *sbuf);
GLOBAL int nand_physic_erase_block(unsigned int chip, unsigned int block);
GLOBAL int nand_physic_read_page(unsigned int chip, unsigned int block, unsigned int page, unsigned int bitmap, unsigned char *mbuf, unsigned char *sbuf);
GLOBAL int nand_physic_block_copy(unsigned int chip_s, unsigned int block_s, unsigned int chip_d, unsigned int block_d);

GLOBAL int PHY_VirtualPageRead(unsigned int nDieNum, unsigned int nBlkNum, unsigned int nPage, uint64 SectBitmap, void *pBuf, void *pSpare);
GLOBAL int PHY_VirtualPageWrite(unsigned int nDieNum, unsigned int nBlkNum, unsigned int nPage, uint64 SectBitmap, void *pBuf, void *pSpare);
...
GLOBAL int nand_erase_chip(unsigned int chip, unsigned int start_block, unsigned int end_block, unsigned int force_flag);
GLOBAL int nand_dragonborad_test_one(unsigned char *buf, unsigned char *oob, unsigned int blk_num);
...
GLOBAL int physic_info_get_one_copy(unsigned int start_block, unsigned int pages_offset, unsigned int *block_per_copy, unsigned int *buf);
GLOBAL int clean_physic_info(void);
GLOBAL int physic_info_read(void);
GLOBAL int physic_info_add_to_uboot_tail(unsigned int *buf_dst, unsigned int uboot_size);
GLOBAL unsigned int  is_uboot_block(unsigned int  block, unsigned char *uboot_buf);
...
GLOBAL unsigned int  cal_sum_physic_info(struct _boot_info *mem_base, unsigned int size);
GLOBAL int change_uboot_start_block(struct _boot_info *info, unsigned int start_block);
...
GLOBAL int nand_secure_storage_read(int item, unsigned char *buf, unsigned int len);
GLOBAL int nand_secure_storage_write(int item, unsigned char *buf, unsigned int len);
...
GLOBAL int nand_secure_storage_read_one(unsigned int block, int item, unsigned char *mbuf, unsigned int len);
