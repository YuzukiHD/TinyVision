...
extern void Spic_config_io_mode(__u32 spi_no, __u32 rxmode, __u32 dbc, __u32 stc);
...
extern __s32 Spic_rw(__u32 spi_no, __u32 tcnt, __u8 *txbuf, __u32 rcnt, __u8 *rxbuf, __u32 dummy_cnt);

/* operations of spi nor flash */
extern __s32 spi_nand_rdid(__u32 spi_no, __u32 chip, __u32 id_addr, __u32 addr_cnt, __u32 id_cnt, void *id);
