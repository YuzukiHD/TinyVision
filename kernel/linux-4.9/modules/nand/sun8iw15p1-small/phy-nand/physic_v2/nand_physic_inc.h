...
GLOBAL void ndfc_enable_ecc(struct _nand_controller_info *nctri, u32 pipline, u32 randomize);
...
GLOBAL void ndfc_set_rand_seed(struct _nand_controller_info *nctri, u32 page_no);
...
GLOBAL int _normal_cmd_io_send(struct _nand_controller_info *nctri, struct _nctri_cmd *icmd);
GLOBAL int _normal_cmd_io_wait(struct _nand_controller_info *nctri, struct _nctri_cmd *icmd);
GLOBAL int _batch_cmd_io_send(struct _nand_controller_info *nctri, struct _nctri_cmd_seq *cmd_list);
GLOBAL int _batch_cmd_io_wait(struct _nand_controller_info *nctri, struct _nctri_cmd_seq *cmd_list);
GLOBAL void ndfc_clean_cmd_seq(struct _nctri_cmd_seq *cmd_list);
GLOBAL void print_cmd_seq(struct _nctri_cmd_seq *cmd_list);
GLOBAL int ndfc_execute_cmd(struct _nand_controller_info *nctri, struct _nctri_cmd_seq *cmd_list);
GLOBAL int ndfc_wait_all_rb_ready(struct _nand_controller_info *nctri);
GLOBAL int ndfc_get_spare_data(struct _nand_controller_info *nctri, u8 *sbuf, u32 udata_cnt);
GLOBAL int ndfc_set_spare_data(struct _nand_controller_info *nctri, u8 *sbuf, u32 udata_cnt);
...
GLOBAL int ndfc_update_ecc_sta_and_spare_data(struct _nand_physic_op_par *npo, int ecc_sta, unsigned char *sbuf);
GLOBAL int wait_reg_status(volatile u32 *reg, u32 mark, u32 value, u32 us);
GLOBAL int ndfc_change_nand_interface(struct _nand_controller_info *nctri, u32 ddr_type, u32 sdr_edo, u32 ddr_edo, u32 ddr_delay);
GLOBAL void ndfc_get_nand_interface(struct _nand_controller_info *nctri, u32 *pddr_type, u32 *psdr_edo, u32 *pddr_edo, u32 *pddr_delay);
...
GLOBAL int ndfc_set_page_size(struct _nand_controller_info *nctri, u32 page_size);
GLOBAL int ndfc_soft_reset(struct _nand_controller_info *nctri);
GLOBAL int ndfc_set_dummy_byte(struct _nand_controller_info *nctri, int dummy_byte);
...
GLOBAL s32 ndfc_set_user_data_len_cfg(struct _nand_controller_info *nctri, u32 udata_cnt);
GLOBAL s32 ndfc_set_user_data_len_cfg_4bytesper1k(struct _nand_controller_info *nctri, u32 udata_cnt);
...
GLOBAL int rawnand_erase_chip(unsigned int chip, unsigned int start_block, unsigned int end_block, unsigned int force_flag);
GLOBAL int rawnand_dragonborad_test_one(unsigned char *buf, unsigned char *oob, unsigned int blk_num);
GLOBAL int rawnand_physic_info_get_one_copy(unsigned int  start_block, unsigned int pages_offset, unsigned int *block_per_copy, unsigned int *buf);
...
GLOBAL int rawnand_write_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int rawnand_read_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int rawnand_write_uboot_one(unsigned char *buf, unsigned int len, struct _boot_info *info_buf, unsigned int info_len, unsigned int counter);
GLOBAL int rawnand_read_uboot_one(unsigned char *buf, unsigned int len, unsigned int counter);
...
GLOBAL struct _nand_controller_info *nctri_get(struct _nand_controller_info *head, unsigned int num);
...
GLOBAL int _check_scan_data(u32 first_check, u32 chip, u32 *scan_good_blk_no, u8 *main_buf);
...
GLOBAL int nci_add_to_nsi(struct _nand_storage_info *nsi, struct _nand_chip_info *node);
GLOBAL int nci_add_to_nctri(struct _nand_controller_info *nctri, struct _nand_chip_info *node);
GLOBAL struct _nand_chip_info *nci_get_from_nsi(struct _nand_storage_info *nsi, unsigned int num);
GLOBAL struct _nand_chip_info *nci_get_from_nctri(struct _nand_controller_info *nctri, unsigned int num);
GLOBAL struct _nand_phy_info_par *search_id(unsigned char *id);
GLOBAL int init_nci_from_id(struct _nand_chip_info *nci, struct _nand_phy_info_par *npi);
GLOBAL int nand_build_nsi(struct _nand_storage_info *nsi, struct _nand_controller_info *nctri);
GLOBAL int read_nand_structure(void *phy_arch, unsigned int *good_blk_no);
GLOBAL int write_nand_structure(void *phy_arch, unsigned int good_blk_no, unsigned int blk_cnt);
...
GLOBAL int nsci_add_to_nssi(struct _nand_super_storage_info *nssi, struct _nand_super_chip_info *node);
GLOBAL struct _nand_super_chip_info *nsci_get_from_nssi(struct _nand_super_storage_info *nssi, unsigned int num);
GLOBAL int init_nsci_from_nctri(struct _nand_super_storage_info *nssi, struct _nand_super_chip_info *nsci, struct _nand_controller_info *nctri, unsigned int channel_num, unsigned int chip_no, unsigned int nsci_num_in_nctri);
GLOBAL int nand_build_nssi(struct _nand_super_storage_info *nssi, struct _nand_controller_info *nctri);
...
GLOBAL int rawnand_physic_erase_super_block(unsigned int chip, unsigned int block);
GLOBAL int rawnand_physic_read_super_page(unsigned int chip, unsigned int block, unsigned int page, unsigned int bitmap, unsigned char *mbuf, unsigned char *sbuf);
GLOBAL int rawnand_physic_write_super_page(unsigned int chip, unsigned int block, unsigned int page, unsigned int bitmap, unsigned char *mbuf, unsigned char *sbuf);
GLOBAL int rawnand_physic_super_bad_block_check(unsigned int chip, unsigned int block);
GLOBAL int rawnand_physic_super_bad_block_mark(unsigned int chip, unsigned int block);
...
GLOBAL int rawnand_physic_bad_block_check(unsigned int chip, unsigned int block);
GLOBAL int rawnand_physic_write_page(unsigned int chip, unsigned int block, unsigned int page, unsigned int bitmap, unsigned char *mbuf, unsigned char *sbuf);
GLOBAL int rawnand_physic_erase_block(unsigned int chip, unsigned int block);
GLOBAL int rawnand_physic_read_page(unsigned int chip, unsigned int block, unsigned int page, unsigned int bitmap, unsigned char *mbuf, unsigned char *sbuf);
GLOBAL int nand_write_data_in_whole_block(unsigned int chip, unsigned int block, unsigned char *mbuf, unsigned int mlen, unsigned char *sbuf, unsigned int slen);
GLOBAL int nand_read_data_in_whole_block(unsigned int chip, unsigned int block, unsigned char *mbuf, unsigned int mlen, unsigned char *sbuf, unsigned int slen);
GLOBAL int rawnand_physic_block_copy(unsigned int chip_s, unsigned int block_s, unsigned int chip_d, unsigned int block_d);
...
GLOBAL int set_ce_rb_for_chip(struct _nand_chip_info *nci, unsigned int channel, unsigned int chips);
...
GLOBAL int nand_first_reset_chip(struct _nand_chip_info *nci, unsigned int chip_no);
...
GLOBAL int nand_first_read_id(struct _nand_chip_info *nci, unsigned int chip_no, unsigned char *id);
GLOBAL unsigned int get_row_addr(unsigned int page_offset_for_next_blk, unsigned int block, unsigned int page);
GLOBAL int fill_cmd_addr(u32 col_addr, u32 col_cycle, u32 row_addr, u32 row_cycle, u8 *abuf);
GLOBAL void set_default_batch_read_cmd_seq(struct _nctri_cmd_seq *cmd_seq);
GLOBAL void set_default_batch_write_cmd_seq(struct _nctri_cmd_seq *cmd_seq, u32 write_cmd1, u32 write_cmd2);
GLOBAL int _change_all_nand_parameter(struct _nand_controller_info *nctri, u32 ddr_type, u32 pre_ddr_type, u32 dclk);
GLOBAL int _get_right_timing_para(struct _nand_controller_info *nctri, u32 ddr_type, u32 *good_sdr_edo, u32 *good_ddr_edo, u32 *good_ddr_delay);
GLOBAL int set_cmd_with_nand_bus(struct _nand_chip_info *nci, u8 *cmd, u32 wait_rb, u8 *addr, u8 *dat, u32 dat_len, u32 counter);
GLOBAL int get_data_with_nand_bus_one_cmd(struct _nand_chip_info *nci, u8 *cmd, u8 *addr, u8 *dat, u32 dat_len);
...
GLOBAL int get_dummy_byte(int physic_page_size, int ecc_mode, int ecc_block_cnt, int user_data_size);
GLOBAL int get_random_cmd2(struct _nand_physic_op_par *npo);
GLOBAL int get_data_block_cnt(unsigned int sect_bitmap);
GLOBAL int get_data_block_cnt_for_boot0_ecccode(struct _nand_chip_info *nci, u8 ecc_mode);
...
GLOBAL int nand_reset_super_chip(struct _nand_super_chip_info *nsci, unsigned int super_chip_no);
GLOBAL int nand_read_super_chip_status(struct _nand_super_chip_info *nsci, unsigned int super_chip_no);
GLOBAL int is_super_chip_rb_ready(struct _nand_super_chip_info *nsci, unsigned int super_chip_no);
...
GLOBAL int m0_read_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m0_write_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m0_read_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int m0_write_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int _generate_page_map_tab(__u32 nand_page_size, __u32 copy_cnt, __u32 page_cnt, __u32 *page_addr, __u32 *page_map_tab_addr, __u32 *tab_size);
...
GLOBAL int m0_use_chip_function(struct _nand_physic_op_par *npo, unsigned int function);
GLOBAL int m0_rw_use_chip_function(struct _nand_physic_op_par *npo, unsigned int function);
...
GLOBAL int m1_read_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m1_write_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m1_read_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int m1_write_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
...
GLOBAL int m8_read_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m8_write_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m8_read_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int m8_write_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
...
GLOBAL s32 m1_get_hynix_special_info(u8 *readbuf, u8 *dstbuf, u32 len, u32 chip);
...
GLOBAL int m2_read_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m2_write_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m2_read_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int m2_write_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
...
GLOBAL int m3_read_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m3_write_boot0_page(struct _nand_chip_info *nci, struct _nand_physic_op_par *npo);
GLOBAL int m3_read_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
GLOBAL int m3_write_boot0_one(unsigned char *buf, unsigned int len, unsigned int counter);
