...
struct _nand_lib_cfg *g_phy_cfg = NULL;

struct _nand_storage_info *g_nsi = NULL;
struct _nand_storage_info g_nsi_data;

struct _nand_super_storage_info *g_nssi = NULL;
struct _nand_super_storage_info g_nssi_data;

struct _nand_controller_info *g_nctri = NULL;
struct _nand_controller_info g_nctri_data[2];

struct __RAWNandStorageInfo_t *g_nand_storage_info = NULL;
struct __RAWNandStorageInfo_t g_nand_storage_info_data;
...
int nand_physic_temp1 = 0;
int nand_physic_temp2 = 0;
int nand_physic_temp3 = 0;
int nand_physic_temp4 = 0;
int nand_physic_temp5 = 0;
int nand_physic_temp6 = 0;
int nand_physic_temp7 = 0;
int nand_physic_temp8 = 0;
...
struct _nand_physic_function nand_physic_function[] = {
	{//driver number:0
		...
		m0_erase_super_block,
		m0_read_super_page,
		m0_write_super_page,
		m0_super_bad_block_check,
		m0_super_bad_block_mark,
