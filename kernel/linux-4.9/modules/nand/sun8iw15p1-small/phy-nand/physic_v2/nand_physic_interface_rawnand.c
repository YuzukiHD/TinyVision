...
void nand_cfg_setting(void)
{
	...
	aw_nand_info.nand_lib_cfg.phy_support_two_plane = nand_support_two_plane();
	aw_nand_info.nand_lib_cfg.phy_nand_support_vertical_interleave = nand_support_vertical_interleave();
	aw_nand_info.nand_lib_cfg.phy_support_dual_channel = nand_support_dual_channel();
