...
#if !defined(CONFIG_PLATFORM_ARM_SUN8I) && !defined(CONFIG_ARCH_SUN50IW10P1)
	RTW_INFO("call enable_irq_wake.irq number:%d\n", oob_irq);
...
#if !defined(CONFIG_PLATFORM_ARM_SUN8I) && !defined(CONFIG_ARCH_SUN50IW10P1)
	RTW_INFO("call disable_irq_wake.irq number:%d\n", oob_irq);
