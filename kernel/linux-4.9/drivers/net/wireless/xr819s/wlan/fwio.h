...
#define XR819S_BOOTLOADER    ("/lib/firmware/boot_xr819s.bin")
#define XR819S_FIRMWARE      ("/lib/firmware/fw_xr819s.bin")
#define XR819S_SDD_FILE      ("/lib/firmware/sdd_xr819s.bin")
#define XR819S_ETF_FIRMWARE   ("/lib/firmware/etf_xr819s.bin")
#else
