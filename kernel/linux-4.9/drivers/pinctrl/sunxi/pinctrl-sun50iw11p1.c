...
static const struct sunxi_desc_pin sun50iw11p1_pins[] = {
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 6),
		...
		SUNXI_FUNCTION(0x4, "spdif_in"),		/* IN */
		SUNXI_FUNCTION(0x5, "spdif_out"),		/* OUT */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 2),
		...
		SUNXI_FUNCTION(0x5, "pll_debug"),	/* PLL_LOCK_DBG */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 14),
		...
		SUNXI_FUNCTION(0x3, "i2s1_dout1"),	/* DOUT1 */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 4),
		...
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "uart3"),		/* TX */
		SUNXI_FUNCTION(0x3, "spi1_0"),		/* CS/DBI_CSX */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 5),
		...
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "uart3"),		/* RX */
		SUNXI_FUNCTION(0x3, "spi1_0"),		/* CLK/DBI_SCLK */
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(H, 6),
		...
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "uart3"),		/* RTS */
		SUNXI_FUNCTION(0x3, "spi1_0"),		/* MOSI/DBI_SDO */
