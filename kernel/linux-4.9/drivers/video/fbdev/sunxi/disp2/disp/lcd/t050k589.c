...
static struct LCM_setting_table jd9365_initialization_4lane_setting[] = {
{0xE0, 1, {0x00}},
{0xE1, 1, {0x93}},
{0xE2, 1, {0x65}},
{0xE3, 1, {0xF8}},
...
static struct LCM_setting_table jd9365_initialization_2lane_setting[] = {
{0xE0, 1, {0x00}},
{0xE1, 1, {0x93}},
{0xE2, 1, {0x65}},
{0xE3, 1, {0xF8}},
...
static void lcd_panel_init(u32 sel)
{
	...
	DBG_INFO("\n");
	struct disp_panel_para *panel_info = kmalloc(sizeof(struct disp_panel_para),
			GFP_KERNEL | __GFP_ZERO);
	bsp_disp_get_panel_info(sel, panel_info);
	if (panel_info->lcd_dsi_lane == LCD_DSI_2LANE) {
		jd9365_initialization_setting = jd9365_initialization_2lane_setting;
		DBG_INFO("2 lane num setting\n");
	} else if (panel_info->lcd_dsi_lane == LCD_DSI_4LANE) {
		jd9365_initialization_setting = jd9365_initialization_4lane_setting;
		DBG_INFO("4 lane num setting\n");
	} else {
		DBG_INFO("only support 2 and 4 lane,other set 4 lane,please check setting !!!\n");
		jd9365_initialization_setting = jd9365_initialization_4lane_setting;
	}
	kfree(panel_info);
	sunxi_lcd_pin_cfg(sel, 1);
