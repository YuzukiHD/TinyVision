...
static const int sun8iw21_de_is_support_smbl[] = {
	/* CH0 */
	0,
};
...
static const int sun8iw21_de_is_support_fcm[] = {
	/* DISP0 CH0 */
	1,
	/* DISP0 CH1 */
	0,
...
int de_feat_is_support_fcm_by_chn(unsigned int disp, unsigned int chn)
{
#ifdef SUPPORT_FCM
	unsigned int i, index = 0;
