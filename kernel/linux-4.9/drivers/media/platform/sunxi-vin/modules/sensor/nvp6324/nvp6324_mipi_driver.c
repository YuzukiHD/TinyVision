...
/*
 * When in sun8iw21 combo csi, this sensor needs info->time_hs = 0x20
 * And combo phy0 deskew reg1 needs 0x0, phy1 deskew reg1 needs 0xA5
 *
 * Note by:  FuMing Cao <caofuming@allwinnertech.com>
 */
