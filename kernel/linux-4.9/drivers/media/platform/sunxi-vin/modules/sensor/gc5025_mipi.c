/*
 * A V4L2 driver for gc5025_mipi cameras.
 *
...
static struct regval_list sensor_qsxga_regs[] = {
	/* 2592*1936 */
	{0x90, 0x01}, /* crop out win mode bit0=1-on 0-off */
	{0x91, 0x00}, /* [2:0] Crop _win_y1[10:8] */
	{0x92, 0x02}, /* Crop _win_y1[7:0] */
	{0x93, 0x00}, /* [3:0] Crop _win_x1[11:8] */
	{0x94, 0x03}, /* Crop _win_x1[7:0] */
	...
	{0x12, 0xa8}, /* raw8=1920,raw10=2592*5/4 */
	{0x13, 0x0c},
...
static int gc5025_sensor_vts;
static int sensor_s_exp(struct v4l2_subdev *sd, unsigned int exp_val)
{
	data_type explow, exphigh;
	unsigned short exp_tmp;
	struct sensor_info *info = to_state(sd);

	if (exp_val > ((gc5025_sensor_vts - 16) << 4))
		exp_val = (gc5025_sensor_vts - 16) << 4;
	if (exp_val < 16)
		exp_val = 16;

	exp_tmp = (exp_val >> 5) << 1;

	exphigh  = (unsigned char)((0x3F00 & exp_tmp) >> 8);
	explow  = (unsigned char)(0xFF & exp_tmp);
