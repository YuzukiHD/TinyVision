...
#define RAW10 1 //raw10 or raw8 select
...
static int sensor_g_fps(struct v4l2_subdev *sd, struct sensor_fps *fps)
{
	...
	sensor_read(sd, 0x41, &frame_length);
	act_vts = frame_length << 8;
	sensor_read(sd, 0x42, &frame_length);
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	sensor_read(sd, 0x17, &sensor_flip_status);//read sensor init flip
