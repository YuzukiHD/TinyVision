...
MODULE_AUTHOR("lcs");
MODULE_DESCRIPTION("A low-level driver for k06 sensors");
MODULE_LICENSE("GPL");
...
#define V4L2_IDENT_SENSOR  0x0852
...
#define DBG_INFO(format, args...) (printk("[k06 MIPI INFO] LINE:%04d-->%s:"format, __LINE__, __func__, ##args))
#define DBG_ERR(format, args...)  (printk("[k06 MIPI ERR] LINE:%04d-->%s:"format, __LINE__, __func__, ##args))
...
static struct regval_list sensor_2560x1440p30_2lane_regs[] = {
	{0x12, 0x70},
	{0x48, 0x86},
	{0x48, 0x06},
	{0x0E, 0x11},
...

{
	...
	shutter = exp_val >> 4;
	if (shutter > k06_sensor_vts - 4)
		frame_length = shutter + 4;
	else
		frame_length = k06_sensor_vts;
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
	...
	printk("------------------------\r\n");
	printk("this is k06 sensor init\r\n");
	printk("------------------------\r\n");
	printk("**********************************\r\n");
	printk("***********sensor init************\r\n");
	printk("**********************************\r\n");
...
static struct sensor_win_size sensor_win_sizes[] = {
	{
		...
		.gain_min   = 1 << 4,
		.gain_max	 = 15 << 4,
		.regs = sensor_2560x1440p30_2lane_regs,
		.regs_size = ARRAY_SIZE(sensor_2560x1440p30_2lane_regs),
		.set_size = NULL,
	},
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	k06_sensor_vts = wsize->vts;
	sensor_dbg("k06_sensor_vts = %d\n", k06_sensor_vts);
