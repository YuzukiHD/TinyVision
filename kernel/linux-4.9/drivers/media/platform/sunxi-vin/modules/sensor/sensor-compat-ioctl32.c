...
{
	if (!access_ok(VERIFY_READ, up, sizeof(struct actuator_para32)) ||
...
static int put_act_init_config32(struct actuator_para *kp,
			      struct actuator_para32 __user *up)
{
	if (!access_ok(VERIFY_WRITE, up, sizeof(struct actuator_para32)) ||
...
{
	if (!access_ok(VERIFY_READ, up, sizeof(struct actuator_ctrl32)) ||
...
static int put_act_code32(struct actuator_ctrl *kp,
			      struct actuator_ctrl32 __user *up)
{
	if (!access_ok(VERIFY_WRITE, up, sizeof(struct actuator_ctrl32)) ||
...
{
	if (!access_ok(VERIFY_READ, up, sizeof(struct flash_para32)) ||
...
static int put_flash_mode32(struct flash_para *kp,
			      struct flash_para32 __user *up)
{
	if (!access_ok(VERIFY_WRITE, up, sizeof(struct flash_para32)) ||
