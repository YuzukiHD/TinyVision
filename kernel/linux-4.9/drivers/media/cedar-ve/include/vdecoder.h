...
//* NO.13
int RotatePicture(struct mem_interface *memOps,
...
VideoPicture *AllocatePictureBuffer(struct mem_interface *memOps,
				    int nWidth,
				    int nHeight,
				    int nLineStride,
				    int ePixelFormat);
...
int FreePictureBuffer(struct mem_interface *memOps,
