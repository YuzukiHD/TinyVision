...
#define asoc_simple_parse_cpu(node, dai_link,					\
	...
	asoc_simple_parse_dai(node, &dai_link->cpu_of_node,			\
			      &dai_link->cpu_dai_name,				\
			      list_name, cells_name, is_single_link)

#define asoc_simple_parse_codec(node, dai_link, list_name, cells_name)		\
	asoc_simple_parse_dai(node, &dai_link->codec_of_node,			\
			      &dai_link->codec_dai_name,			\
			      list_name, cells_name, NULL)

#define asoc_simple_parse_platform(node, dai_link, list_name, cells_name)	\
	asoc_simple_parse_dai(node, &dai_link->platform_of_node, NULL,		\
			      list_name, cells_name, NULL)
