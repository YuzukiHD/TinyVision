...
#define SUNXI_CODEC_MAP_TO_DAUDIO
#endif
...
#ifdef SUNXI_CODEC_MAP_TO_DAUDIO
/* must be the same as sound/cord/pcm_dmaengine.c */
...
enum sunxi_codec_i2s_port {
	SUNXI_CODEC_MAP_PORT_NULL = 0,
	SUNXI_CODEC_MAP_PORT_I2S0 = 1,
	SUNXI_CODEC_MAP_PORT_I2S1 = 2,
	SUNXI_CODEC_MAP_PORT_I2S2 = 3,
};

struct sunxi_i2s_params {
	struct device *dev;
...
struct sunxi_codec_info {
	...
	bool mad_clk_enable;
#endif
	struct sunxi_i2s_params *sunxi_daudio;
	struct sunxi_i2s_params daudio[3];
	struct dmaengine_pcm_runtime_data *prtd;
	int i2s_port;
	unsigned int buffer_bytes;
	unsigned int period_bytes;
	bool i2s_mapdma_trigger;
#endif
};

#ifdef SUNXI_CODEC_MAP_TO_DAUDIO
#ifdef CONFIG_SND_SUNXI_MAD
extern void sunxi_codec_map_i2s_mad_suspend_reset(struct sunxi_codec_info *sunxi_codec);
#endif
#endif
