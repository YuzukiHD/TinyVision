...
static int codec_init(struct sunxi_codec *sunxi_internal_codec)
{
	...
	snd_soc_update_bits(sunxi_internal_codec->codec, BD_CAL_CTRL,
			    (0x7 << BIAS_PA_POWER_CTRL), (7 << BIAS_PA_POWER_CTRL));
	snd_soc_update_bits(sunxi_internal_codec->codec, CP_LDO_CTRL,
			    (0x3 << CP_LDO_OUT_VOL_CTRL), (2 << CP_LDO_OUT_VOL_CTRL));
