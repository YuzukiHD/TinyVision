...
struct port_index {
	...
	MBUS_PORT_CPU,   MBUS_PORT_GPU,   MBUS_PORT_MAHB,
	MBUS_PORT_DMA,   MBUS_PORT_VE0,   MBUS_PORT_CE,
	MBUS_PORT_TSC0,	 MBUS_PORT_NDFC0, MBUS_PORT_CSI0,
	MBUS_PORT_DI0,   MBUS_PORT_DE300, MBUS_PORT_G2D_ROT,
	MBUS_PORT_CSI1,  MBUS_PORT_VE1,   MBUS_PORT_IOMMU,
	MBUS_PORTS_MAX,
};
