...
#ifndef __SUNXI_STMMAC_PLATFORM_DATA
#define __SUNXI_STMMAC_PLATFORM_DATA

#include <linux/platform_device.h>
#include <linux/phy.h>
#if IS_ENABLED(CONFIG_AW_TSN)
#include <sunxi-tsn.h>
#endif
...
struct plat_stmmacenet_data {
	...
	bool sph_disable;
/*
*     TSN functions (if CONFIG_AW_TSN)
*
* int (*tsn_capable)(struct net_device *dev);
*     If a particular device is capable of sustaining TSN traffic
*     provided current configuration
*
* int (*tsn_link_configure)(struct net_device *dev,
*                              enum sr_class class,
*                              u16 framesize,
*                              u16 vid,
*                              u8 add_link,
