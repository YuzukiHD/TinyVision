...
#define CONFIG_CMSIS_USER_DATA_ID 2
...
static void thread_cleanup(rt_thread_t thread)
{
    ...
    thread_cb = (thread_cb_t *)(thread->user_data[CONFIG_CMSIS_USER_DATA_ID]);
...
osThreadId_t osThreadNew(osThreadFunc_t func, void *argument, const osThreadAttr_t *attr)
{
    ...
    thread_cb->thread.user_data[CONFIG_CMSIS_USER_DATA_ID] = (rt_uint32_t)thread_cb;
...
osThreadId_t osThreadGetId(void)
{
    ...
    return (osThreadId_t)(thread->user_data[CONFIG_CMSIS_USER_DATA_ID]);
}
...
osStatus_t osThreadTerminate(osThreadId_t thread_id)
{
    ...
    thread_cb = (thread_cb_t *)(rt_thread_self()->user_data[CONFIG_CMSIS_USER_DATA_ID]);
