 ...
 */
int hex2bin(__u8 *dst, const char *src, size_t count)
{
	while (count--) {
 ...
 *
 * Given a buffer of __u8 data, hex_dump_to_buffer() converts the input data
 ...
 * @ascii: include ASCII after the hex output
 *
 * Given a buffer of __u8 data, print_hex_dump() prints a hex + ASCII dump
