...
#include "ccu-sun8i-v851se.h"

static const struct clk_parent_data osc24M[] = { { .fw_name = "hosc" } };

/*
 * For the CPU PLL, the output divider is described as "only for testing"
 * in the user manual. So it's not modelled and forced to 0.
 */
#define SUN8I_V851SE_PLL_CPU_REG 0x000
...
#define SUN8I_V851SE_PLL_DDR_REG 0x010
...
#define SUN8I_V851SE_PLL_PERIPH_REG 0x020
...
static SUNXI_CCU_M(pll_periph_2x_clk, "pll-periph-2x", "pll-periph-4x", 0x020,
		   16, 3, 0);
...
static const struct clk_hw *pll_periph_480M_hws[] = {
 ...
 * in the user manual. So it's not modelled and forced to 0.
 */
#define SUN8I_V851SE_PLL_VIDEO_REG 0x040
...
static const struct clk_hw *pll_video_4x_hws[] = { &pll_video_4x_clk.common.hw };
static CLK_FIXED_FACTOR_HWS(pll_video_2x_clk, "pll-video-2x", pll_video_4x_hws,
			    2, 1, CLK_SET_RATE_PARENT);
static CLK_FIXED_FACTOR_HWS(pll_video_1x_clk, "pll-video-1x", pll_video_4x_hws,
 ...
 * in the user manual. So it's not modelled and forced to 0.
 */
#define SUN8I_V851SE_PLL_CSI_REG 0x048
...
static const struct clk_hw *pll_csi_4x_hws[] = { &pll_csi_4x_clk.common.hw };
static CLK_FIXED_FACTOR_HWS(pll_csi_2x_clk, "pll-csi-2x", pll_csi_4x_hws, 2, 1,
			    CLK_SET_RATE_PARENT);
static CLK_FIXED_FACTOR_HWS(pll_csi_clk, "pll-csi", pll_csi_4x_hws, 4, 1,
			    CLK_SET_RATE_PARENT);
 ...
 */
#define SUN8I_V851SE_PLL_AUDIO_REG 0x078
...
static const struct clk_hw *pll_audio_hws[] = { &pll_audio_clk.common.hw };
static SUNXI_CCU_M_HWS(pll_audio_div2_clk, "pll-audio-div2", pll_audio_hws,
		       0x078, 16, 3, 0);
static SUNXI_CCU_M_HWS(pll_audio_div5_clk, "pll-audio-div5", pll_audio_hws,
		       0x078, 20, 3, 0);

static SUNXI_CCU_M(pll_audio_4x_clk, "pll-audio-4x", "pll-audio-div2", 0xE00, 5,
		   5, 0);
static SUNXI_CCU_M(pll_audio_1x_clk, "pll-audio-1x", "pll-audio-div5", 0xE00, 0,
		   5, 0);
 ...
 * in the user manual. So it's not modelled and forced to 0.
 */
#define SUN8I_V851SE_PLL_NPU_REG 0x080
...
static const struct clk_hw *pll_npu_4x_hws[] = { &pll_npu_4x_clk.common.hw };
static CLK_FIXED_FACTOR_HWS(pll_npu_2x_clk, "pll-npu-2x", pll_npu_4x_hws, 2, 1,
			    CLK_SET_RATE_PARENT);
static CLK_FIXED_FACTOR_HWS(pll_npu_1x_clk, "pll-npu-1x", pll_npu_4x_hws, 4, 1,
			    CLK_SET_RATE_PARENT);
...
static SUNXI_CCU_MUX_DATA(cpu_clk, "cpu", cpu_parents, 0x500, 24, 3,
			  CLK_SET_RATE_PARENT | CLK_IS_CRITICAL);

static SUNXI_CCU_M(cpu_axi_clk, "cpu-axi", "cpu", 0x500, 0, 2, 0);
static SUNXI_CCU_M(cpu_apb_clk, "cpu-apb", "cpu", 0x500, 8, 2, 0);
...
static SUNXI_CCU_MP_DATA_WITH_MUX(ahb_clk, "ahb", ahb_parents, 0x510, 0,
				  5, /* M */
				  8, 2, /* P */
				  24, 2, /* mux */
				  0);

static SUNXI_CCU_MP_DATA_WITH_MUX(apb0_clk, "apb0", ahb_parents, 0x520, 0,
				  5, /* M */
				  8, 2, /* P */
				  24, 2, /* mux */
				  0);

static SUNXI_CCU_MP_DATA_WITH_MUX(apb1_clk, "apb1", ahb_parents, 0x524, 0,
				  5, /* M */
				  8, 2, /* P */
				  24, 2, /* mux */
				  0);
...
static SUNXI_CCU_M_HW_WITH_MUX_GATE(de_clk, "de", de_g2d_parents, 0x600, 0,
				    5, /* M */
				    24, 1, /* mux */
				    BIT(31), /* gate */
				    CLK_SET_RATE_PARENT);
...
static SUNXI_CCU_M_HW_WITH_MUX_GATE(g2d_clk, "g2d", de_g2d_parents, 0x630, 0,
				    5, /* M */
				    24, 1, /* mux */
				    BIT(31), /* gate */
				    0);
...
static SUNXI_CCU_M_HW_WITH_MUX_GATE(ce_clk, "ce", ce_parents, 0x680, 0,
				    4, /* M */
				    24, 3, /* mux */
				    BIT(31), /* gate */
				    CLK_SET_RATE_PARENT);

static SUNXI_CCU_GATE_HWS(bus_ce_clk, "bus-ce", ahb_hws, 0x68c, BIT(0) | BIT(1),
			  0);

static const struct clk_hw *ve_parents[] = {
	&pll_periph_300M_clk.hw,	&pll_periph_400M_clk.hw,
	&pll_periph_480M_clk.common.hw, &pll_npu_4x_clk.common.hw,
	&pll_video_4x_clk.common.hw,	&pll_csi_4x_clk.common.hw,
};
static SUNXI_CCU_M_HW_WITH_MUX_GATE(ve_clk, "ve", ve_parents, 0x690, 0,
				    5, /* M */
				    24, 3, /* mux */
				    BIT(31), /* gate */
				    CLK_SET_RATE_PARENT);
...
static SUNXI_CCU_M_HW_WITH_MUX_GATE(npu_clk, "npu", npu_parents, 0x6e0, 0,
				    5, /* M */
				    24, 3, /* mux */
				    BIT(31), /* gate */
				    CLK_SET_RATE_PARENT);

static SUNXI_CCU_GATE_HWS(bus_npu_clk, "bus-npu", ahb_hws, 0x6ec, BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_dma_clk, "bus-dma", ahb_hws, 0x70c, BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_msgbox0_clk, "bus-msgbox0", ahb_hws, 0x71c,
			  BIT(0), 0);
static SUNXI_CCU_GATE_HWS(bus_msgbox1_clk, "bus-msgbox1", ahb_hws, 0x71c,
			  BIT(1), 0);

static SUNXI_CCU_GATE_HWS(bus_spinlock_clk, "bus-spinlock", ahb_hws, 0x72c,
			  BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_hstimer_clk, "bus-hstimer", ahb_hws, 0x73c,
			  BIT(0), 0);

static SUNXI_CCU_GATE_DATA(avs_clk, "avs", osc24M, 0x740, BIT(31), 0);

static SUNXI_CCU_GATE_HWS(bus_dbg_clk, "bus-dbg", ahb_hws, 0x78c, BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_pwm_clk, "bus-pwm", apb0_hws, 0x7ac, BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_iommu_clk, "bus-iommu", apb0_hws, 0x7bc, BIT(0),
			  0);
...
static SUNXI_CCU_MP_HW_WITH_MUX_GATE(dram_clk, "dram", dram_parents, 0x800, 0,
				     5, /* M */
				     8, 2, /* P */
				     24, 3, /* mux */
				     BIT(31), CLK_IS_CRITICAL);

static CLK_FIXED_FACTOR_HW(mbus_clk, "mbus", &dram_clk.common.hw, 4, 1, 0);

static const struct clk_hw *mbus_hws[] = { &mbus_clk.hw };

static SUNXI_CCU_GATE_HWS(mbus_dma_clk, "mbus-dma", mbus_hws, 0x804, BIT(0), 0);
static SUNXI_CCU_GATE_HWS(mbus_ve_clk, "mbus-ve", mbus_hws, 0x804, BIT(1), 0);
static SUNXI_CCU_GATE_HWS(mbus_ce_clk, "mbus-ce", mbus_hws, 0x804, BIT(2), 0);
static SUNXI_CCU_GATE_HWS(mbus_csi_clk, "mbus-csi", mbus_hws, 0x804, BIT(8), 0);
static SUNXI_CCU_GATE_HWS(mbus_isp_clk, "mbus-isp", mbus_hws, 0x804, BIT(9), 0);
static SUNXI_CCU_GATE_HWS(mbus_g2d_clk, "mbus-g2d", mbus_hws, 0x804, BIT(10),
			  0);

static SUNXI_CCU_GATE_HWS(bus_dram_clk, "bus-dram", ahb_hws, 0x80c, BIT(0),
			  CLK_IS_CRITICAL);
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(mmc2_clk, "mmc2", mmc2_parents, 0x838, 0,
				       4, /* M */
				       8, 2, /* P */
				       24, 3, /* mux */
				       BIT(31), /* gate */
...
static SUNXI_CCU_GATE_HWS(bus_uart0_clk, "bus-uart0", apb1_hws, 0x90c, BIT(0),
			  0);
static SUNXI_CCU_GATE_HWS(bus_uart1_clk, "bus-uart1", apb1_hws, 0x90c, BIT(1),
			  0);
static SUNXI_CCU_GATE_HWS(bus_uart2_clk, "bus-uart2", apb1_hws, 0x90c, BIT(2),
			  0);
static SUNXI_CCU_GATE_HWS(bus_uart3_clk, "bus-uart3", apb1_hws, 0x90c, BIT(3),
			  0);
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(spi0_clk, "spi0", spi_parents, 0x940, 0,
				       4, /* M */
				       8, 2, /* P */
				       24, 3, /* mux */
				       BIT(31), /* gate */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(spi1_clk, "spi1", spi_parents, 0x944, 0,
				       4, /* M */
				       8, 2, /* P */
				       24, 3, /* mux */
				       BIT(31), /* gate */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(spi2_clk, "spi2", spi_parents, 0x948, 0,
				       4, /* M */
				       8, 2, /* P */
				       24, 3, /* mux */
				       BIT(31), /* gate */
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE(spi3_clk, "spi3", spi_parents, 0x94c, 0,
				       4, /* M */
				       8, 2, /* P */
				       24, 3, /* mux */
				       BIT(31), /* gate */
...
static SUNXI_CCU_GATE_HWS(bus_spi3_clk, "bus-spi3", ahb_hws, 0x96c, BIT(3), 0);
...
static SUNXI_CCU_GATE_HWS_WITH_PREDIV(emac_25M_clk, "emac-25M",
				      pll_periph_150M_hws, 0x970,
				      BIT(31) | BIT(30), 6, 0);

static SUNXI_CCU_GATE_HWS(bus_emac_clk, "bus-emac", ahb_hws, 0x97c, BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_gpadc_clk, "bus-gpadc", apb0_hws, 0x9ec, BIT(0),
			  0);
...
static SUNXI_CCU_M_HW_WITH_MUX_GATE(i2s_clk, "i2s", audio_parents, 0xa14, 0,
				    4, /* M */
				    24, 1, /* mux */
				    BIT(31), /* gate */
				    0);

static SUNXI_CCU_GATE_HWS(bus_i2s_clk, "bus-i2s", apb0_hws, 0xa20, BIT(1), 0);

static SUNXI_CCU_M_HW_WITH_MUX_GATE(dmic_clk, "dmic", audio_parents, 0xa40, 0,
				    4, /* M */
				    24, 3, /* mux */
				    BIT(31), /* gate */
				    0);

static SUNXI_CCU_GATE_HWS(bus_dmic_clk, "bus-dmic", apb0_hws, 0xa4c, BIT(0), 0);

static SUNXI_CCU_M_HW_WITH_MUX_GATE(audio_dac_clk, "audio-dac", audio_parents,
				    0xa50, 0, 4, /* M */
				    24, 3, /* mux */
				    BIT(31), /* gate */
				    0);

static SUNXI_CCU_M_HW_WITH_MUX_GATE(audio_adc_clk, "audio-adc", audio_parents,
				    0xa54, 0, 4, /* M */
				    24, 3, /* mux */
				    BIT(31), /* gate */
				    0);

static SUNXI_CCU_GATE_HWS(bus_audio_clk, "bus-audio", apb0_hws, 0xa5c, BIT(0),
			  0);
...
static SUNXI_CCU_M_DATA_WITH_MUX_GATE(mipi_dsi_clk, "mipi-dsi",
				      mipi_dsi_parents, 0xb24, 0, 4, /* M */
				      24, 3, /* mux */
				      BIT(31), /* gate */
				      CLK_SET_RATE_PARENT);

static SUNXI_CCU_GATE_HWS(bus_mipi_dsi_clk, "bus-mipi-dsi", ahb_hws, 0xb4c,
			  BIT(0), 0);
...
static SUNXI_CCU_GATE_HWS(bus_tcon_lcd_clk, "bus-tcon-lcd", ahb_hws, 0xb7c,
			  BIT(0), 0);
...
static SUNXI_CCU_M_DATA_WITH_MUX_GATE(csi_mclk0_clk, "csi-mclk0",
				      csi_mclk_parents, 0xc08, 0, 5, /* M */
				      24, 3, /* mux */
				      BIT(31), /* gate */
				      0);

static SUNXI_CCU_M_DATA_WITH_MUX_GATE(csi_mclk1_clk, "csi-mclk1",
				      csi_mclk_parents, 0xc0c, 0, 5, /* M */
				      24, 3, /* mux */
				      BIT(31), /* gate */
				      0);

static SUNXI_CCU_M_DATA_WITH_MUX_GATE(csi_mclk2_clk, "csi-mclk2",
				      csi_mclk_parents, 0xc10, 0, 5, /* M */
				      24, 3, /* mux */
				      BIT(31), /* gate */
				      0);

static SUNXI_CCU_GATE_HWS(bus_csi_clk, "bus-csi", ahb_hws, 0xc2c, BIT(0), 0);

static SUNXI_CCU_GATE_HWS(bus_wiegand_clk, "bus-wiegand", apb0_hws, 0xc7c,
			  BIT(0), 0);
...
static struct clk_div_table riscv_axi_table[] = { { .val = 1, .div = 2 },
						  { .val = 2, .div = 3 },
						  { .val = 3, .div = 4 },
						  { /* Sentinel */ } };
...
static SUNXI_CCU_GATE_HWS(bus_riscv_cfg_clk, "bus-riscv", ahb_hws, 0xd0c,
			  BIT(0), 0);
...
static SUNXI_CCU_GATE_DATA(fanout_24M_clk, "fanout-24M", osc24M, 0xf30, BIT(0),
			   0);
...
static SUNXI_CCU_M_HW_WITH_MUX_GATE(fanout_27M_clk, "fanout-27M",
				    fanout_27M_parents, 0xf34, 0, 5, /* M */
				    24, 2, /* mux */
				    BIT(31), /* gate */
				    0);
...
static struct ccu_common *sun8i_v851se_ccu_clks[] = {
	&pll_cpu_clk.common,
	&pll_ddr_clk.common,
...
static struct clk_hw_onecell_data sun8i_v851se_hw_clks = {
	.num	= CLK_NUMBER,
	.hws	= {
...
static struct ccu_reset_map sun8i_v851se_ccu_resets[] = {
...
static const struct sunxi_ccu_desc sun8i_v851se_ccu_desc = {
	.ccu_clks = sun8i_v851se_ccu_clks,
	.num_ccu_clks = ARRAY_SIZE(sun8i_v851se_ccu_clks),

	.hw_clks = &sun8i_v851se_hw_clks,

	.resets = sun8i_v851se_ccu_resets,
	.num_resets = ARRAY_SIZE(sun8i_v851se_ccu_resets),
};

static const u32 pll_regs[] = {
	SUN8I_V851SE_PLL_CPU_REG,    SUN8I_V851SE_PLL_DDR_REG,
	SUN8I_V851SE_PLL_PERIPH_REG, SUN8I_V851SE_PLL_VIDEO_REG,
	SUN8I_V851SE_PLL_CSI_REG,    SUN8I_V851SE_PLL_AUDIO_REG,
	SUN8I_V851SE_PLL_NPU_REG,
};

static int sun8i_v851se_ccu_probe(struct platform_device *pdev)
{
	void __iomem *reg;
	u32 val;
	int i, ret;
	...
	val = readl(reg + SUN8I_V851SE_PLL_CPU_REG);
	val &= ~GENMASK(1, 0);
	writel(val, reg + SUN8I_V851SE_PLL_CPU_REG);
	 ...
	 */
	val = readl(reg + SUN8I_V851SE_PLL_VIDEO_REG);
	val &= ~BIT(0);
	writel(val, reg + SUN8I_V851SE_PLL_VIDEO_REG);
	 ...
	 */
	val = readl(reg + SUN8I_V851SE_PLL_CSI_REG);
	val &= ~BIT(0);
	writel(val, reg + SUN8I_V851SE_PLL_CSI_REG);
	 ...
	 */
	val = readl(reg + SUN8I_V851SE_PLL_NPU_REG);
	val &= ~BIT(0);
	writel(val, reg + SUN8I_V851SE_PLL_NPU_REG);

	/* Force fanout-27M factor N to 0. */
	val = readl(reg + SUN8I_V851SE_FANOUT_27M_REG);
	val &= ~GENMASK(9, 8);
	writel(val, reg + SUN8I_V851SE_FANOUT_27M_REG);

	ret = devm_sunxi_ccu_probe(&pdev->dev, reg, &sun8i_v851se_ccu_desc);
	if (ret)
		return ret;
...
static const struct of_device_id sun8i_v851se_ccu_ids[] = {
	{ .compatible = "allwinner,sun8i-v851se-ccu" },
	{}
};

static struct platform_driver sun8i_v851se_ccu_driver = {
	.probe	= sun8i_v851se_ccu_probe,
	.driver	= {
		.name			= "sun8i-v851se-ccu",
		.suppress_bind_attrs	= true,
		.of_match_table		= sun8i_v851se_ccu_ids,
	},
};
module_platform_driver(sun8i_v851se_ccu_driver);
