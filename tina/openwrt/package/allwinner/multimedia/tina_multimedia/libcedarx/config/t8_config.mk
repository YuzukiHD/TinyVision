...
##----------------------- for openmax config begin ------------------------->##
##---: if support 4K 30fps recoder
#LOCAL_CFLAGS += -DCONF_SUPPORT_4K_30FPS_RECORDER

##---: scaledown when resolution more than 1080p
#LOCAL_CFLAGS += -DCONF_OMX_BIG_SIZE_SCALEDOWN

##---: omx drop B frame
LOCAL_CFLAGS += -DCONF_OMX_DROP_B_FRAME_4K

##---: DI process enable
#LOCAL_CFLAGS += -DCONF_ENABLE_OPENMAX_DI_FUNCTION

##---: for the function of hdr and afbc
#LOCAL_CFLAGS += -DCONF_SURPPORT_METADATA_BUFFER


##<-----------------------for openmax config end ----------------------------##
