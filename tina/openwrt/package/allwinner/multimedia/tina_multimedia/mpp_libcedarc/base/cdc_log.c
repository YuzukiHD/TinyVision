...
enum CDC_LOG_LEVEL_TYPE CDC_GLOBAL_LOG_LEVEL = LOG_LEVEL_INFO;
enum CDC_LOG_LEVEL_TYPE GLOBAL_LOG_LEVEL = LOG_LEVEL_INFO;

#ifndef __ANDROID__
const char *CDC_LOG_LEVEL_NAME[] = {
     "",
     "",
