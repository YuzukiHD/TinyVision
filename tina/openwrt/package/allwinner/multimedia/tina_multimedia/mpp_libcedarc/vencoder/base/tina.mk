# Makefile for eyesee-mpp/middleware/media/LIBRARY/libcedarc/vencoder/base
CUR_PATH := .
...
LOCAL_TARGET_DYNAMIC := libvenc_base
endif
ifeq ($(MPPCFG_COMPILE_STATIC_LIB), Y)
LOCAL_TARGET_STATIC := libvenc_base
endif
LOCAL_TARGET_BIN :=
...
all: $(target_dynamic) $(target_static)
	@echo ===================================
	@echo build eyesee-mpp-middleware-media-LIBRARY-libcedarc-vencoder-base done
	@echo ===================================
